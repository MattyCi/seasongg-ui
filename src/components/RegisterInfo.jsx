            ...
            <form id="registerForm" className={validated ? "was-validated" : "needs-validation"} onSubmit={handleRegister} noValidate>
                ...
                <div className="input-group has-validation">
                    <input name="username" type="text" className="form-control my-2" id="register-username" placeholder="Enter Username" autoComplete="off"
                        ...
                        maxLength="32"
                        pattern="[a-zA-Z0-9\-']+" />
                    <div className="invalid-feedback">Username must be 3-32 characters and contain only letters, numbers, hyphens, and apostrophes.</div>
                </div>
                <div className="input-group has-validation">
                    ...
                    <div className="invalid-feedback">Password must be 8-32 characters and contain at least one lowercase letter, one uppercase letter, and one digit.</div>
                </div>
                <div className="input-group has-validation">
