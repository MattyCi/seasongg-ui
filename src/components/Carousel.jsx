...
export default function Carousel() {
  return (
    <div id="sgg-carousel" className="row carousel carousel-fade season-gg-carousel-height season-gg-carousel-width bg-primary py-2 px-4 my-3 mx-lg-auto" data-bs-ride="carousel" data-bs-pause="hover">
      ...
      <div className="carousel-item active" data-bs-interval="5000">
        <div className="row">
          ...
          <div id="carousel-text-0" className="col-7 col-sm-6 pl-sm-5 text-white my-auto">
              <p className="season-gg-carousel-title-text font-weight-bold">Create a Season</p>
              <p className="season-gg-carousel-text">
                  Play your favorite game with your buddies and see who truly is the best.
              </p>
          </div>
          <div id="carousel-img-0" className="col-5 col-sm-6 text-center bg-primary my-auto">
      ...
      <div className="carousel-item" data-bs-interval="5000">
        <div className="row">
          ...
          <div id="carousel-img-1" className="col-5 col-sm-6 text-center bg-primary pt-2 my-auto">
      ...
      <div className="carousel-item" data-bs-interval="5000">
        <div className="row">
          ...
          <div id="carousel-img-2" className="col-5 col-sm-6 text-center bg-primary pt-2 my-auto">
